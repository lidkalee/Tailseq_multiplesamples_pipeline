...
for val in ${StringArray[@]}; do 
	echo "sample_${val}"; salmon quant -i salmon/pombe_index -l MSF -r  "data/${val}R1_001.fastq.paired.fq.gz" -p 8 --validateMappings -o "R2_allsamples/alignmentR1/${val}R1_quant"  --writeMappings "R2_allsamples/alignmentR1/${val}R1_salmon.sam"; 
done
