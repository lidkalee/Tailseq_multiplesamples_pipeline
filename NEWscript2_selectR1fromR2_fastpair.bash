...
for val in ${StringArray[@]}; do 
	echo "sample_${val}"; gunzip "data/${val}R1_001.fastq.gz"; fastq_pair "data/${val}R1_001.fastq" "R2_allsamples/filter/${val}R2_removedUMIs.fastq"; gzip "data/${val}R1_001.fastq"; rm "data/${val}R1_001.fastq.single.fq" "R2_allsamples/filter/${val}R2_removedUMIs.fastq" "R2_allsamples/filter/${val}R2_removedUMIs.fastq.paired.fq" "R2_allsamples/filter/${val}R2_removedUMIs.fastq.single.fq"; 
done
